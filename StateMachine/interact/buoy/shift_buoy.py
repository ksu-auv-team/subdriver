...
class Shift_Buoy(Sub):
    ...
    def strafe_right(self):
        ...
        start_strafe = rospy.get_time()#!/usr/bin/env python
from StateMachine.gbl import *
from StateMachine.const import *
from StateMachine.sub import *
import rospy
...
class Shift_Buoy(Sub):
    ...
    def execute(self, userdata):
        # At this point, the sub is stationary and facing the Bu#!/usr/bin/env python
from StateMachine.gbl import *
from StateMachine.const import *
from StateMachine.sub import *
import rospy
...
class Shift_Buoy(Sub):
    ...
    def log(self):
        rospy.loginfo("Executing state SHIFT_BUOY")oy
        self.init_state()
        gbl.state_heading = gbl.heading
